...
const Dashboard = () => {
  ...
  const fetchPatients = () => {
    axios.get(`https://medicne-remainder-backend.onrender.com/getAllUsers?limit=${patientsPerPage}&pages=${currentPage}`)
    .then(response => {
  ...
  const searchPatients = async () => {
    const res = await axios.get(`https://medicne-remainder-backend.onrender.com/searchByUserName?name=${searchText}&limit=${patientsPerPage}&pages=${currentPage}`);
